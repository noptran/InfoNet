...
namespace Infonet.Web.ViewModels.Clients {
	public class HouseholdSearchViewModel : PagedListPagination {

		public HouseholdSearchViewModel() {
		...
		public IPagedList<HouseholdSearchResult> HouseholdList { get; set; }

		public class HouseholdSearchResult {
			public HouseholdSearchResult() {
