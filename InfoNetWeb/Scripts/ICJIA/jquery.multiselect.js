/**
@Ray Heimnesss - Added Tabindex -1 and class dirtyignore to button which is only used to display text
				 Made Change to Always display number selected
**/
...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div class="ms-options-wrap dirtyignore"><button tabindex=-1>None Selected</button><div class="ms-options"><ul></ul></div></div>');
