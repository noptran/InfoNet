...
namespace Infonet.Reporting.StandardReports.ReportTables.Services.NonClientCrisisIntervention {
	public class CrisisInterventionRaceReportTable : ReportTable<CrisisInterventionLineItem> {
		public CrisisInterventionRaceReportTable (string title, int displayOrder) : base(title, displayOrder) {
		}
