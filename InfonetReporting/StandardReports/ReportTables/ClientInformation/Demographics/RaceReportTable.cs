...
namespace Infonet.Reporting.StandardReports.ReportTables.ClientInformation.Demographics {
	public class RaceReportTable : ReportTable<ClientInformationDemographicsLineItem> {
		public RaceReportTable (string title, int displayOrder) : base(title, displayOrder) {
		}
