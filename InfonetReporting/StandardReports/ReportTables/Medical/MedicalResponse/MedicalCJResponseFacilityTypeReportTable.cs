...
namespace Infonet.Reporting.StandardReports.ReportTables.Medical.MedicalResponse {
	public class MedicalCJResponseFacilityTypeReportTable : ReportTable<MedicalSystemInvolvementLineItem> {
		public MedicalCJResponseFacilityTypeReportTable(string title, int displayOrder) : base(title, displayOrder) {
