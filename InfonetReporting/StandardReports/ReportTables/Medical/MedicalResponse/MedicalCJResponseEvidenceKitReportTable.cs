...
namespace Infonet.Reporting.StandardReports.ReportTables.Medical.MedicalResponse {
	public class MedicalCJResponseEvidenceKitReportTable : ReportTable<MedicalSystemInvolvementLineItem> {
		public MedicalCJResponseEvidenceKitReportTable(string title, int displayOrder) : base(title, displayOrder) { }
