...
namespace Infonet.Reporting.StandardReports.ReportTables.Medical.OrderOfProtection {
	public class MedicalCJOPVictimsWithActiveOrdersReportTable : ReportTable<MedicalCJOrderofProtectionLineItem> {
		private readonly HashSet<int?> _clientIds = new HashSet<int?>();

		public MedicalCJOPVictimsWithActiveOrdersReportTable(string title, int displayOrder) : base(title, displayOrder) { }
