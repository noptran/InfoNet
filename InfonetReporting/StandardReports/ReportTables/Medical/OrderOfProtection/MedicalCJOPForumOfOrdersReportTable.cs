...
namespace Infonet.Reporting.StandardReports.ReportTables.Medical.OrderOfProtection {
	public class MedicalCJOPForumOfOrdersReportTable : ReportTable<MedicalCJOrderofProtectionLineItem> {
		private double _divisor = 0.0;

		public MedicalCJOPForumOfOrdersReportTable(string title, int displayOrder) : base(title, displayOrder) { }
