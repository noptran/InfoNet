...
namespace Infonet.Reporting.StandardReports.ReportTables.Medical.ProsecutionInvolvement {
	public class ProsecutionStateAttorneyInterviewReportTable : ReportTable<MedicalCJPoliceProsecutionLineItem> {
		public ProsecutionStateAttorneyInterviewReportTable(string title, int displayOrder) : base(title, displayOrder) {
